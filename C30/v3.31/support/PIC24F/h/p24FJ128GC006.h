/*-------------------------------------------------------------------------
 * MPLAB-Cxx  PIC24FJ128GC006 processor header
 *
 * (c) Copyright 1999-2011 Microchip Technology, All rights reserved
 *-------------------------------------------------------------------------*/

#ifndef __PIC24FJ128GC006__
#error "Include file does not match processor setting"
#endif

#ifndef __24FJ128GC006_H
#define __24FJ128GC006_H
...
extern volatile unsigned long longADL3MSEL __attribute__((__sfr__));
...
extern volatile unsigned long longADL0MSEL __attribute__((__sfr__));
...
extern volatile unsigned long longADL1MSEL __attribute__((__sfr__));
...
extern volatile unsigned long longADL2MSEL __attribute__((__sfr__));
...
/* Bitname _CMPOE cannot be defined because it is used by more than one SFR */
...
#define _SDOFFCAL SD1CON1bits.SDOFFCAL
...
#define _CHOPSEL0 SD1CON2bits.CHOPSEL0
#define _CHOPSEL1 SD1CON2bits.CHOPSEL1
