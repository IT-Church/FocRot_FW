/*-------------------------------------------------------------------------
 * MPLAB-Cxx  PIC24FJ64GB502 processor header
 *
 * (c) Copyright 1999-2011 Microchip Technology, All rights reserved
 *-------------------------------------------------------------------------*/

#ifndef __PIC24FJ64GB502__
#error "Include file does not match processor setting"
#endif

#ifndef __24FJ64GB502_H
#define __24FJ64GB502_H
...
**     FNOSC_PRI            High Precision Oscillator
**     FNOSC_PRIPLL         High Precision Oscillator with PLL module
