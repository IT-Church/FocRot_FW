...
extern volatile ADCBUF0BITS ADCBUF0bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF1 __attribute__((__sfr__));
typedef struct tagADCBUF1BITS {
  unsigned ADCBUF1:10;
} ADCBUF1BITS;
extern volatile ADCBUF1BITS ADCBUF1bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF2 __attribute__((__sfr__));
typedef struct tagADCBUF2BITS {
  unsigned ADCBUF2:10;
} ADCBUF2BITS;
extern volatile ADCBUF2BITS ADCBUF2bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF3 __attribute__((__sfr__));
typedef struct tagADCBUF3BITS {
  unsigned ADCBUF3:10;
} ADCBUF3BITS;
extern volatile ADCBUF3BITS ADCBUF3bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF4 __attribute__((__sfr__));
typedef struct tagADCBUF4BITS {
  unsigned ADCBUF4:10;
} ADCBUF4BITS;
extern volatile ADCBUF4BITS ADCBUF4bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF5 __attribute__((__sfr__));
typedef struct tagADCBUF5BITS {
  unsigned ADCBUF5:10;
} ADCBUF5BITS;
extern volatile ADCBUF5BITS ADCBUF5bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF6 __attribute__((__sfr__));
typedef struct tagADCBUF6BITS {
  unsigned ADCBUF6:10;
} ADCBUF6BITS;
extern volatile ADCBUF6BITS ADCBUF6bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF7 __attribute__((__sfr__));
typedef struct tagADCBUF7BITS {
  unsigned ADCBUF7:10;
} ADCBUF7BITS;
extern volatile ADCBUF7BITS ADCBUF7bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF8 __attribute__((__sfr__));
typedef struct tagADCBUF8BITS {
  unsigned ADCBUF8:10;
} ADCBUF8BITS;
extern volatile ADCBUF8BITS ADCBUF8bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUF9 __attribute__((__sfr__));
typedef struct tagADCBUF9BITS {
  unsigned ADCBUF9:10;
} ADCBUF9BITS;
extern volatile ADCBUF9BITS ADCBUF9bits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUFA __attribute__((__sfr__));
typedef struct tagADCBUFABITS {
  unsigned ADCBUFA:10;
} ADCBUFABITS;
extern volatile ADCBUFABITS ADCBUFAbits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUFB __attribute__((__sfr__));
typedef struct tagADCBUFBBITS {
  unsigned ADCBUFB:10;
} ADCBUFBBITS;
extern volatile ADCBUFBBITS ADCBUFBbits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUFC __attribute__((__sfr__));
typedef struct tagADCBUFCBITS {
  unsigned ADCBUFC:10;
} ADCBUFCBITS;
extern volatile ADCBUFCBITS ADCBUFCbits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUFD __attribute__((__sfr__));
typedef struct tagADCBUFDBITS {
  unsigned ADCBUFD:10;
} ADCBUFDBITS;
extern volatile ADCBUFDBITS ADCBUFDbits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUFE __attribute__((__sfr__));
typedef struct tagADCBUFEBITS {
  unsigned ADCBUFE:10;
} ADCBUFEBITS;
extern volatile ADCBUFEBITS ADCBUFEbits __attribute__((__sfr__));

extern volatile unsigned int  ADCBUFF __attribute__((__sfr__));
typedef struct tagADCBUFFBITS {
  unsigned ADCBUFF:10;
} ADCBUFFBITS;
extern volatile ADCBUFFBITS ADCBUFFbits __attribute__((__sfr__));
...
/* ADCBUF0 */
#define _ADCBUF0 ADCBUF0bits.ADCBUF0

/* ADCBUF1 */
#define _ADCBUF1 ADCBUF1bits.ADCBUF1

/* ADCBUF2 */
#define _ADCBUF2 ADCBUF2bits.ADCBUF2

/* ADCBUF3 */
#define _ADCBUF3 ADCBUF3bits.ADCBUF3

/* ADCBUF4 */
#define _ADCBUF4 ADCBUF4bits.ADCBUF4

/* ADCBUF5 */
#define _ADCBUF5 ADCBUF5bits.ADCBUF5

/* ADCBUF6 */
#define _ADCBUF6 ADCBUF6bits.ADCBUF6

/* ADCBUF7 */
#define _ADCBUF7 ADCBUF7bits.ADCBUF7

/* ADCBUF8 */
#define _ADCBUF8 ADCBUF8bits.ADCBUF8

/* ADCBUF9 */
#define _ADCBUF9 ADCBUF9bits.ADCBUF9

/* ADCBUFA */
#define _ADCBUFA ADCBUFAbits.ADCBUFA

/* ADCBUFB */
#define _ADCBUFB ADCBUFBbits.ADCBUFB

/* ADCBUFC */
#define _ADCBUFC ADCBUFCbits.ADCBUFC

/* ADCBUFD */
#define _ADCBUFD ADCBUFDbits.ADCBUFD

/* ADCBUFE */
#define _ADCBUFE ADCBUFEbits.ADCBUFE

/* ADCBUFF */
#define _ADCBUFF ADCBUFFbits.ADCBUFF
