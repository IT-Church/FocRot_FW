/*-------------------------------------------------------------------------
 * MPLAB-Cxx  dsPIC33FJ128GP706A processor header
 *
 * (c) Copyright 1999-2011 Microchip Technology, All rights reserved
 *-------------------------------------------------------------------------*/

#ifndef __dsPIC33FJ128GP706A__
#error "Include file does not match processor setting"
#endif

#ifndef __33FJ128GP706A_H
#define __33FJ128GP706A_H
...
__extension__ typedef struct tagAD2PCFGLBITS {
  union {
    struct {
      unsigned PCFG:16;
    };
...
__extension__ typedef struct tagAD2CSSLBITS {
  union {
    struct {
      unsigned CSSL:16;
    };
...
/* AD2PCFGL */
#define _PCFG AD2PCFGLbits.PCFG
