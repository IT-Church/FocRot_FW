...
//This preprocessor conditional statement is to avoid unintended linking for unsuppported devices.
	...
	defined (cmp_v3_1) || defined (LIB_BUILD)
...
#if defined (cmp_v2_4) ||defined (cmp_v2_6) || defined (cmp_v2_7) ||defined (cmp_v2_8)   
...
#if defined (cmp_v2_1) || defined (cmp_v2_2) || defined (cmp_v2_3)||defined (cmp_v2_5)||defined (cmp_v2_6) ||defined (cmp_v2_8)||defined (cmp_v3_1)
...
#define CMP_VRef_SELECT_32_STEPS         0x0000 /* 0.25 CVRSRC to 0.75 CVRSRC, with CVRSRC/32 step size */
#define CMP_VRef_STEP_SELECT_MASK        (~CMP_VRef_SELECT_24_STEPS)
#elif defined (cmp_v2_7) ||defined (cmp_v2_8)
...
#if defined (cmp_v2_6) ||defined (cmp_v2_7) ||defined (cmp_v2_8)
...
#if defined (cmp_v2_2) || defined (cmp_v2_3) ||defined (cmp_v2_5) ||defined (cmp_v2_6)|| defined (cmp_v3_1) ||defined (LIB_BUILD)

#if defined (cmp_v2_6) || defined (LIB_BUILD) 
/*****************************************************************************
...
#if defined (cmp_v2_1) || defined (cmp_v2_4) ||defined (cmp_v2_6) || defined (cmp_v2_8)
/******************************************************************************
 Macro      : mCMP2_EnblDsbl(state)
 Overview   : Macro Enables/Disables the Comparator 2
 Parameter  : state - *1 Comparator is enabled 
...
#if defined (cmp_v2_1) || defined (cmp_v2_4) ||defined (cmp_v2_6) ||defined (cmp_v2_7) || defined (cmp_v2_8)
/******************************************************************************
 Macro      : mCMP1_EnblDsbl(state)
 Overview   : Macro Enables/Disables the Comparator 1
 Parameter  : state - *1 Comparator is enabled 
