...
//This preprocessor conditional statement is to avoid unintended linking for unsuppported devices.
 ...
 #define CTMU_CURR_RANGE_1000_BASE_CURR 0x0300 /*Current source Range is 1000*Base current (550uA) */
 #define CTMU_CURR_RANGE_100_BASE_CURR  0x0200 /*Current source Range is 100*Base current (55uA) */
 #define CTMU_CURR_RANGE_10_BASE_CURR   0x0100 /*Current source Range is 10*Base current (5.5uA)*/
 #define CTMU_CURR_RANGE_BASE_CURR      0x0000 /*Current source Range is Base current (0.55uA)*/
 #endif
