...
#define OC_FAULT0_IN_ENABLE         0xffff /*PWM Fault 0 Input Enabled*/
#define OC_FAULT0_IN_DISABLE    	0xff7f /*PWM Fault 0 Input Disabled*/
...
#define OC_DIRN_OUTPUT              0xffff  /*The signal ocmp_oe_out is forced to zero*/
#define OC_DIRN_TRIS                0xffdf  /*The signal ocmp_oe_out can be active*/
