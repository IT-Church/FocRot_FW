 ...
 */
#define MY_DEFAULT_HOST_NAME			"FOCUSLYNX"
 ...
 */
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] = 
		{
			...
			{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 600, 150},
			...
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 300},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 300},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 300},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 200, 300},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 200, 300},
...
// -- HTTP2 Server options -----------------------------------------------
	...
	#define HTTP_DEFAULT_FILE		"focuser1.htm"
	#define HTTPS_DEFAULT_FILE		"focuser1.htm"
	#define HTTP_DEFAULT_LEN		(12u)		// For buffer overrun protection.
...
// -- Telnet Options -----------------------------------------------------
	...
	#define TELNET_PASSWORD			"in4optec"
